...
class PermissionsControllerTest < ActionController::TestCase
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post :create, permission: { permcl_action_id: @permission.permcl_action_id, permcl_id: @permission.permcl_id, user_id: @permission.user_id }
    end
  ...
  test "should update permission" do
    patch :update, id: @permission, permission: { permcl_action_id: @permission.permcl_action_id, permcl_id: @permission.permcl_id, user_id: @permission.user_id }
    assert_redirected_to permission_path(assigns(:permission))
  end
